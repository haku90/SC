...
public:
	...
	double lastTimeBus;					//!< Czas ostatniej zmiany w kolejce autobusów.
	double meanLengthBus;				//!< Œrednia d³ugoœæ kolejki autobusów.
	double lengthBus;					//!< Aktualna d³ugoœæ kolejki autobusów.
private:
