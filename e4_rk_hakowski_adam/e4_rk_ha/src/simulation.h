...
//---------------------------------------------
	...
	estAvgBusAirPort+=ap.meanLengthBus/Clock;
	estVarBusAirPort+=ap.meanLengthBus/Clock*ap.meanLengthBus/Clock;

	estAvgPassAirPort+=ap.meanLength/Clock;
	estVarPassAirPort+=ap.meanLength/Clock*ap.meanLength/Clock;

	estAvgGuestH1+=h1.meanLength/Clock;
	estVartGuestH1+=h1.meanLength/Clock*h1.meanLength/Clock;

	estAvgGuestH2+=h2.meanLength/Clock;
	estVartGuestH2+=h2.meanLength/Clock*h2.meanLength/Clock;

	estAvgGuestH3+=h3.meanLength/Clock;
	estVartGuestH3+=h3.meanLength/Clock*h3.meanLength/Clock;

	estAvgGuestH4+=h4.meanLength/Clock;
	estVartGuestH4+=h4.meanLength/Clock*h4.meanLength/Clock;
	...
	estAvgTaxiH1+=h1.numOftaxi/(Clock/60);
	estVarTaxiH1+=h1.numOftaxi/(Clock/60)*h1.numOftaxi/(Clock/60);

	estAvgTaxiH2+=h2.numOftaxi/(Clock/60);
	estVarTaxiH2+=h2.numOftaxi/(Clock/60)*h2.numOftaxi/(Clock/60);

	estAvgTaxiH3+=h3.numOftaxi/(Clock/60);
	estVarTaxiH3+=h3.numOftaxi/(Clock/60)*h3.numOftaxi/(Clock/60);

	estAvgTaxiH4+=h4.numOftaxi/(Clock/60);
	estVarTaxiH4+=h4.numOftaxi/(Clock/60)*h4.numOftaxi/(Clock/60);
...
//	stats.close();
	...
	estVarPassAirPort=(1.0/(M-1.0))*(estVarPassAirPort-M*estAvgPassAirPort*estAvgBusAirPort);
